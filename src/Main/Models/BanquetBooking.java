...
public class BanquetBooking extends Reservation {
    ...
    public BanquetBooking(int id, Owner owner, User user, String status, String paymentStatus, double totalPrice, String from,String hour,ArrayList<Use> uses, String note) throws Exception {
